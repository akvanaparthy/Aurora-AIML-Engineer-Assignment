...
| Config | Tokens/Request | Cost/Request | Cost/1000 Requests |
|--------|---------------|--------------|-------------------|
| Budget | ~10,000 | $0.003 | $3.00 |
| Balanced | ~20,000 | $0.006 | $6.00 |
| Quality | ~30,000 | $0.009 | $9.00 |

*Actual costs may vary based on query complexity and dataset size*

## Best Practices

1. **Start with defaults** - They're well-tuned for most use cases
2. **Monitor logs** - Watch token usage and adjust if needed
3. **Test different modes** - Try Budget/Quality modes with sample queries
4. **Adjust gradually** - Make small changes and test
5. **Balance cost vs quality** - Higher isn't always better if defaults work well

## Need Help?

See `test-adaptive-search.md` for detailed examples and testing instructions.
